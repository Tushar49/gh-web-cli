...
[![npm](https://img.shields.io/npm/v/gh-web-cli.svg)](https://www.npmjs.com/package/gh-web-cli)
[![license](https://img.shields.io/npm/l/gh-web-cli.svg)](LICENSE)
...
- Post comments + edit PR body
- Multi-step rebases without ever calling `git push`
...
|---|:-:|:-:|:-:|
| Personal laptop, personal account | ✅ | ✅ | ✅ |
| Corporate laptop, work SSO | ⚠️ flaky | ⚠️ EMU-limited | ✅ |
| Managed Windows + Credential Manager popups | ❌ hangs | ⚠️ | ✅ |
| Microsoft EMU account on public repos | ❌ | ❌ unauthorized | ✅ |
| Anywhere a personal PAT isn't allowed by policy | ❌ | ❌ | ✅ |
...
gh-web-cli conflict  Resolve PR merge conflicts (auto / ours / theirs / custom)
...
gh-web-cli rebase    End-to-end rebase: sync fork + upload changed files + resolve conflicts
gh-web-cli browser   Manage the underlying CDP connection
```
...
Early. Ships with the techniques originally reverse-engineered to land [a handful of PRs](https://github.com/Tushar49) from a managed Microsoft EMU laptop where every other tool failed. PRs welcome — especially for non-Chromium browsers, non-Windows quirks, and additional GitHub flows.
